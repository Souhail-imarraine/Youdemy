                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-4">
                                <form action="" method="POST" class="space-y-4">
                                    <div>
                                        <label for="categoryName" class="block text-sm font-medium text-gray-700">Nom de
                                            la catégorie</label>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-3">
                                        <form action="" method="post">
                                            <button class="text-red-600 hover:text-red-900" title="Supprimer" name="deleteCategorie">
